...
class Bug(models.Model):
    ...
    bugdetail=models.CharField('bug详情',max_length=200)#bug详情
    ...
    buglevel=models.CharField(verbose_name='严重程度',choices=BUG_LEVEL,default='3',max_length=200,null=True)#bug严重程度
